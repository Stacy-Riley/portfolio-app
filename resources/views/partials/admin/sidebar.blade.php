        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item special-item">
                    <a class="nav-link" href="{{ route('dashboard') }}"  aria-label="go to admin dashboard" >
                      <span>
                ...
                <li class="nav-item special-item">
                    <a class="nav-link" href="{{ route('profiles.index') }}"  aria-label="go to blog posts index page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('services.index') }}"  aria-label="go to business services index page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('projects.index') }}"  aria-label="go to business services index page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('testimonials.index') }}"  aria-label="go to testimonials index page" >
                        <span >
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('blogs.index') }}"  aria-label="go to blog posts index page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('contacts.index') }}"  aria-label="go to book products index page" >
                      <span>
